<footer class="footer section m-4">
    <div class="row">
        <div class="col-12 col-lg-6 mb-4 mb-lg-0">
            <p class="mb-0 text-center text-xl-left">Copyright © 2021-<span class="current-year"></span> <a
                    class="text-primary fw-normal" href="" target="_blank">MO Distribuidora</a></p>
        </div>
        ...
        <div class="col-12 col-lg-6">
            ...
            <ul class="list-inline list-group-flush list-group-borderless text-center text-xl-right mb-0">
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://themesberg.com/about">Acerca de nosotros</a>
                </li>
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="">Contacto</a>
                </li>
